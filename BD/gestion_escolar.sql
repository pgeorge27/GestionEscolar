...
ALTER TABLE `tbl_autorizado`
 ADD PRIMARY KEY (`id_autorizado`), ADD KEY `id_parentesco` (`id_parentesco`);
...
ALTER TABLE `tbl_estudiante`
 ADD PRIMARY KEY (`id_estudiante`), ADD UNIQUE KEY `id_estudiante_2` (`id_estudiante`), ADD KEY `id_nivel` (`id_nivel`), ADD KEY `id_estudiante` (`id_estudiante`), ADD KEY `id_estudiante_3` (`id_estudiante`), ADD KEY `id_representante` (`id_representante_m`), ADD KEY `id_representante_p` (`id_representante_p`,`id_autorizado`,`id_medicamentos`,`id_nivel`), ADD KEY `id_autorizado` (`id_autorizado`), ADD KEY `id_medicamentos` (`id_medicamentos`);

--
-- Indices de la tabla `tbl_estudiante_cursos`
--
ALTER TABLE `tbl_estudiante_cursos`
 ADD PRIMARY KEY (`id_estudiante`,`id_cursos`), ADD KEY `id_estudiante` (`id_estudiante`), ADD KEY `id_cursos` (`id_cursos`), ADD KEY `id_estudiante_2` (`id_estudiante`,`id_cursos`);
